    ...
    return (
        ...
        >
            <div className="relative flex justify-center items-center h-20 px-6">
                ...
                {/* Right Menu */}
                <div className="absolute right-6 hidden md:flex items-center space-x-6 text-[var(--tempi-global-color2)] font-medium">
                    {navLinks.map((link) =>
                        link.label === "ROOM" ? (
                            <div
                                key={link.label}
                            ...
                            >
                                <button
                                    ...
                                    } hover:underline cursor-pointer underline-offset-4`}
                                >
                                    ROOM
                                    <ChevronDown
                                        size={16}
